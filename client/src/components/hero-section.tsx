      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-blue-200 max-w-3xl mx-auto">
            {company?.heroDescription || "Lamplight Technology specializes in cutting-edge SaaS platforms that transform how businesses operate, scale, and succeed in the digital economy."}
          </p>
